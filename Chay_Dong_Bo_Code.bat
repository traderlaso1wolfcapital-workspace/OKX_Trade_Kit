...
robocopy "%~dp0." "D:\4. Trade Coin - TLS1\4. Cursor - IDE\OKX_Trade_Kit" /MIR /XO /XD .venv __pycache__ .git json_data python_nuget .gemini cython_build obf_dist build dist App_Release Output Update_Package Old TLS1_Trading_App /XF *.json .env_* *.pyd *.c *.log /NDL /NC /NS /NP
