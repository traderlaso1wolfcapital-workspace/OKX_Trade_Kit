...
# SVG paths from Lucide (lucide.dev)
LUCIDE_SVGS = {
    ...
    "square": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>',
    ...
    "message-circle": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7.9 20A9 9 0 1 0 4 16.1L2 22Z"/></svg>',
    "sun": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="4"/><path d="M12 2v2"/><path d="M12 20v2"/><path d="M5 5l1.4 1.4"/><path d="M17.6 17.6l1.4 1.4"/><path d="M2 12h2"/><path d="M20 12h2"/><path d="M5 19l1.4-1.4"/><path d="M17.6 6.4l1.4-1.4"/></svg>',
    ...
    "line-chart": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="{color}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>',
...
def get_icon(name, color="#F5F5F7", size=24):
    """
    Returns a QIcon for the given Lucide icon name, properly tinted.
    """
    svg_str = LUCIDE_SVGS.get(name, "")
    if not svg_str:
        return QIcon()
    
    svg_str = svg_str.format(color=color)
