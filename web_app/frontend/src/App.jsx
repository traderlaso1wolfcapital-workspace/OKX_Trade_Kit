...
function App() {
  ...
  const handleFastConnect = () => {
    ...
    const okxOAuthUrl = `https://www.okx.com/oauth2/v1/authorize?client_id=${clientId}&response_type=code&redirect_uri=${redirectUri}&scope=read_only%20trade&state=${state}`;
