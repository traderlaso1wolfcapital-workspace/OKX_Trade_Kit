...
def main():
    ...
    if not os.path.exists(env_file):
        ...
        print("Vui lòng tạo file .api_sub1 trong thư mục z_bot_sub1 hoặc chỉ định đúng file.")
        sys.exit(1)
        
    acc_name = os.path.basename(env_file).replace(".api_sub1", "").replace(".api", "").replace("_", "")
